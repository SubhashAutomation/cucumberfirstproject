...
public class Steps2 {
	...
	public void user_enter_correct_useranme_and_correct_password(DataTable credentials) {
		List<List<String>> ls = credentials.raw();
		driver.findElement(By.xpath("//input[@id = 'okta-signin-username']")).sendKeys(ls.get(0).get(0));
	    driver.findElement(By.xpath("//input[@id = 'okta-signin-password']")).sendKeys(ls.get(0).get(1));
